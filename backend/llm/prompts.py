...
- 본문 요점은 - 불릿 목록으로 작성한다.
- 근거 인용은 ## 근거 섹션 아래 - [번호] 문서·장·절 — 내용 형식.
...
- ## 유의사항 또는 ## 근거 마지막에 근거 부족 여부를 한 줄로 명시하라.
""".strip()
...
- 근거 [번호]마다 해당 Evidence Text의 고유 내용만 1~2문장으로 쓸 것.
""".strip()
...
- 군별 답변 문장을 복사하지 않고, 교리 관점 차이와 합동 시사점을 압축한다.
