...
class VLLMClient(BaseLLMClient):
    ...
    def __init__(self) -> None:
        ...
        if not base:
            raise RuntimeError("VLLM_BASE_URL is not set (expected e.g. https://xxxx.ngrok-free.app/v1)")
    ...
    async def chat(
        ...
        payload: dict[str, Any] = {
            ...
            "stream": False,
            "frequency_penalty": config.VLLM_FREQUENCY_PENALTY,
            # Qwen3: 영어 추론 블록(redacted_thinking) 비활성화 + 반복 억제
            "extra_body": {
        ...
        return parse_openai_chat_content(data)
